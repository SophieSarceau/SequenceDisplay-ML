...
def parse_args():
    ...
    parser.add_argument('--esm_file', type=str, default="../../data/params/esm2_t33_650M_UR50D.pt", help='esm file')
...
if __name__ == "__main__":
    ...
    esm2, esm2_batch_converter, alphabet = load_esm(args.esm_file)
    extract_feature(esm2, esm2_batch_converter, alphabet, args.pdb_dir, args.save_dir)
